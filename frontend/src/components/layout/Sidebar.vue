...
<template>
  <aside class="w-20 bg-white dark:bg-gray-900 border-r border-gray-200 dark:border-gray-800 flex flex-col items-center py-6 space-y-8 transition-colors duration-200">
    ...
    <!-- Main Navigation - Rustige spacing -->
    <nav class="flex flex-col space-y-6 flex-1">
      ...
      >
        ...
        <!-- Tooltip -->
        <div class="absolute left-14 top-1/2 transform -translate-y-1/2 bg-gray-900 dark:bg-gray-700 text-white px-2 py-1 rounded text-sm opacity-0 group-hover:opacity-100 transition-opacity duration-200 pointer-events-none z-50">
          {{ item.name }}
